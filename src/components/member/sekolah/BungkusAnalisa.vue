<template>
  <section class="ui container">
    <navigasi :highlight1="true" :highlight2="false" :highlight3="false" :highlight4="false" :highlight5="false"></navigasi>
    <section>
          ...
          <div class="ui segment">
            <div class="ui middle aligned divided list">
             <!--  <div style="padding:1em;" class="item">
              ...
              <div style="padding:1em;" class="item">
                <div class="content">
                  <router-link class="grey-text" to="/dashboard"><i class="home icon"></i>Dashboard</router-link>                 
                </div>
              </div>
              <div style="padding:1em;" class="item">
                <router-link class="grey-text" to="/analisa"><i class="chart bar icon"></i><b>Analisa</b></router-link>                                 
              </div>
            </div>
          </div>
        </div>
...
<script>
    ...
    import KontenUtama from './KontenAnalisa';
    ...
    export default {
        ...
        created () {
          ...
          document.title = 'Vidyanusa Educational Clustering | Analisa';
        },
        data(){
          return{
            username: '',
